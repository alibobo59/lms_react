    ...
    <div className="min-h-screen flex flex-col items-start justify-between gap-8 md:p-8  p-4 pt-8 pb-0">
      <div className="space-y-5">
        <div className="flex flex-wrap gap-5 items-center">
          {/* card container*/}
          <div className="flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 h-24 rounded-md">
            {/*Card */}
        ...
        <div>
          ...
          <div className="flex flex-col items-center max-w-4xp w-full overflow-hidden rounded-md bg-white border border-gray-500/20">
